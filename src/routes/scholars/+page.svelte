...
// @ts-nocheck
   ...
   */
    ...
    onMount(async () => {
      scholars = [
        { id: 1, name: 'Affan Dhia', year: '2015', imageUrl: 'src/lib/listOfScholars/Affan-Dhia.jpg' },
        { id: 2, name: 'Aldi Fahrezi', year: '2015', imageUrl: 'src/lib/listOfScholars/Aldi-Fahrezi.jpg' },
        { id: 3, name: 'David Theo', year: '2015', imageUrl: 'src/lib/listOfScholars/David-Theo.jpg' },
        { id: 4, name: 'Fachrur Rozi', year: '2015', imageUrl: 'src/lib/listOfScholars/Fachrur-Rozi.jpg' },
        { id: 5, name: 'Fahmi', year:'2015', imageUrl: 'src/lib/listOfScholars/Fahmi.jpg'},
        { id: 6, name: 'Firman Hadi', year: '2015', imageUrl: 'src/lib/listOfScholars/Firman-Hadi.jpg' },
        { id: 7, name: 'Nella Zabrina', year: '2016', imageUrl: 'src/lib/listOfScholars/Nella-Zabrina.jpg' },
        { id: 8, name: 'Tirta Abimanyu', year: '2016', imageUrl: 'src/lib/listOfScholars/Tirta-Abimanyu.jpg' },
        { id: 9, name: 'Valentina', year: '2016', imageUrl: 'src/lib/listOfScholars/Valentina.jpg' },
        { id: 10, name: 'Windi Chandra', year:'2016', imageUrl: 'src/lib/listOfScholars/Windi-Chandra.jpg'},
        { id: 11, name: 'Khatya Puteri', year: '2017', imageUrl: 'src/lib/listOfScholars/Khatya-Puteri.jpg' },
        { id: 12, name: 'Muhammad Irfan', year: '2017', imageUrl: 'src/lib/listOfScholars/Muhammad-Irfan.jpg' },
